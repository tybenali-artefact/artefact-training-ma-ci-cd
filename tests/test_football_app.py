...
class TestAppComponents:
    ...
    def test_sample_data_structure(self):
        ...
        required_columns = [
            'home_team', 'away_team', 'home_goals_avg', 'away_goals_avg',
            'home_possession', 'away_possession', 'home_shots_avg', 'away_shots_avg',
            'home_form', 'away_form', 'weather_rainy', 'weather_windy',
            'temperature', 'venue_capacity', 'outcome'
        ]
    ...
    def test_batch_prediction_structure(self):
        ...
        for i in range(n_predictions):
            ...
            total_prob = (results['home_win_probs'][i] + 
