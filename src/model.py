...
class FootballPredictor:
    ...
    def predict_match(self, match_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Prepare features
        features = np.array([[match_data[col] for col in self.feature_columns]])
...
def create_sample_data() -> pd.DataFrame:
    ...
    data = {
        ...
        'away_goals_avg': np.random.normal(1.6, 0.5, n_matches),
        'home_possession': np.random.normal(55, 10, n_matches),
        'away_possession': np.random.normal(45, 10, n_matches),
        'home_shots_avg': np.random.normal(12, 3, n_matches),
        'away_shots_avg': np.random.normal(10, 3, n_matches),
        ...
        'temperature': np.random.normal(20, 10, n_matches),
